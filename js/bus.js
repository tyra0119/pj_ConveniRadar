...
import { DATA_V } from './config.js?v=df487c55';
import { calendarScore, odpt, serviceMin, specificSet } from './odpt.js?v=df487c55';
import { fetchJson, fmtMin, haversine, parseHHMM } from './util.js?v=df487c55';
