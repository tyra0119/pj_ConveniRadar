...
import { DATA_V } from './config.js?v=1b2fd914';
import { calendarScore, odpt, serviceMin, specificSet } from './odpt.js?v=1b2fd914';
import { fetchJson, fmtMin, haversine, parseHHMM } from './util.js?v=1b2fd914';
