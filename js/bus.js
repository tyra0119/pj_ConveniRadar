...
import { DATA_V } from './config.js?v=619d9080';
import { calendarScore, odpt, serviceMin, specificSet } from './odpt.js?v=619d9080';
import { fetchJson, fmtMin, haversine, parseHHMM } from './util.js?v=619d9080';
