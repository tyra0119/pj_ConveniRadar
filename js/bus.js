...
import { DATA_V } from './config.js?v=96f7e0f6';
import { calendarScore, odpt, serviceMin, specificSet } from './odpt.js?v=96f7e0f6';
import { fetchJson, fmtMin, haversine, parseHHMM } from './util.js?v=96f7e0f6';
