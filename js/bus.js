...
import { DATA_V } from './config.js?v=53ca199a';
import { calendarScore, odpt, serviceMin, specificSet } from './odpt.js?v=53ca199a';
import { fetchJson, fmtMin, haversine, parseHHMM } from './util.js?v=53ca199a';
