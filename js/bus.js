...
import { DATA_V } from './config.js?v=499868f9';
import { calendarScore, odpt, serviceMin, specificSet } from './odpt.js?v=499868f9';
import { fetchJson, fmtMin, haversine, parseHHMM } from './util.js?v=499868f9';
