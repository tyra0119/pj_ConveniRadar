...
import { DATA_V } from './config.js?v=9c449be1';
import { calendarScore, odpt, serviceMin, specificSet } from './odpt.js?v=9c449be1';
import { fetchJson, fmtMin, haversine, parseHHMM } from './util.js?v=9c449be1';
