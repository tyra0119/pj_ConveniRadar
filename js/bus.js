...
import { DATA_V } from './config.js?v=933c2d17';
import { calendarScore, odpt, serviceMin, specificSet } from './odpt.js?v=933c2d17';
import { fetchJson, fmtMin, haversine, parseHHMM } from './util.js?v=933c2d17';
