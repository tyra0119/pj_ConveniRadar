...
import { DATA_V } from './config.js?v=d7d61813';
import { calendarScore, odpt, serviceMin, specificSet } from './odpt.js?v=d7d61813';
import { fetchJson, fmtMin, haversine, parseHHMM } from './util.js?v=d7d61813';
