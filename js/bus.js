...
import { DATA_V } from './config.js?v=e58db5ca';
import { calendarScore, odpt, serviceMin, specificSet } from './odpt.js?v=e58db5ca';
import { fetchJson, fmtMin, haversine, parseHHMM } from './util.js?v=e58db5ca';
