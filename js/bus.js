...
import { DATA_V } from './config.js?v=22425172';
import { calendarScore, odpt, serviceMin, specificSet } from './odpt.js?v=22425172';
import { fetchJson, fmtMin, haversine, parseHHMM } from './util.js?v=22425172';
