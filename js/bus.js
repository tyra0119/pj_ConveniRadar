...
import { DATA_V } from './config.js?v=7add0f74';
import { calendarScore, odpt, serviceMin, specificSet } from './odpt.js?v=7add0f74';
import { fetchJson, fmtMin, haversine, parseHHMM } from './util.js?v=7add0f74';
