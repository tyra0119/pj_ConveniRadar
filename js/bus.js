...
import { DATA_V } from './config.js?v=9beb78a2';
import { calendarScore, odpt, serviceMin, specificSet } from './odpt.js?v=9beb78a2';
import { fetchJson, fmtMin, haversine, parseHHMM } from './util.js?v=9beb78a2';
